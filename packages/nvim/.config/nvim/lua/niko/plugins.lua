...
vim.keymap.set({ 'x', 'o' }, 'if', function() ts_sel.select_textobject('@function.inner', 'textobjects') end,
    { desc = 'inner function' })
vim.keymap.set({ 'x', 'o' }, 'aa', function() ts_sel.select_textobject('@parameter.outer', 'textobjects') end,
    { desc = 'outer parameter' })
vim.keymap.set({ 'x', 'o' }, 'ia', function() ts_sel.select_textobject('@parameter.inner', 'textobjects') end,
...
vim.keymap.set('n', '[f', function() ts_move.goto_previous_start('@function.outer', 'textobjects') end,
    { desc = 'Prev function' })
vim.keymap.set('n', ']a', function() ts_move.goto_next_start('@parameter.inner', 'textobjects') end,
    { desc = 'Next parameter' })
vim.keymap.set('n', '[a', function() ts_move.goto_previous_start('@parameter.inner', 'textobjects') end,
    { desc = 'Prev parameter' })
